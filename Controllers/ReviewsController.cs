...
namespace DoctorAppointmentManagement.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public ReviewsController(DoctorAppointmentManagementContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("review_Id,A_Id,D_Id,P_Id,Rating,Comments")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("review_Id,A_Id,D_Id,P_Id,Rating,Comments")] Review review)
        {
